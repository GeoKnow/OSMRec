...
public class TrainInstanceVectors {
    ...
    private static final int NUMBER_OF_AREA = 25;
    private static final int NUMBER_OF_POINTS = 25;
    ...
    public TrainInstanceVectors(List<OSMWay> wayList, List<OSMRelation> relationList, Map<String,String> mappings, Map<String,Integer> mappingsWithIDs, 
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
        ...
        id++;
        //System.out.println("must be 1466" + id);
