...
public class OccurrencesParser {
    
    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(OccurrencesParser.class);
    private List<String> namesList;
        ...
        public void parseNamesFile(File file){
            ...
            try {
                ...
                Logger.getLogger(OccurrencesParser.class.getName()).log(Level.SEVERE, null, ex);
            }
            while(input.hasNext()) {
